...
export default function Contact() {
  ...
  return (
    ...
    <div className="mb-10 flex flex-col w-3/4 m-auto py-20 justify-center items-center">

      <p className="p-5 text-2xl font-semibold">Do you have any question? contact me</p>

      <div className="flex flex-col md:flex-row gap-5 mt-5"> 

        <div className="flex flex-col justify-center items-center w-full rounded-lg bg-gray-300 shadow-lg shadow-slate-500 "> 
      ...
      <form onSubmit={submit} className="w-full px-10 pt-20 rounded-lg bg-gray-300 p-5 shadow-lg shadow-slate-500">
